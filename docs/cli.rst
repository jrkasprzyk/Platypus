...
Starting with version 0.1.1, Plotypus offers several command-line tools.  To
...
.. code:: bash
   ...
   plotypus solve --algorithm NSGAII --problem DTLZ2 --nfe 10000 --output NSGAII_DTLZ2.set
...
.. code:: bash
   ...
   plotypus solve --algorithm NSGAII --problem DTLZ2 --nfe 10000 population_size=250

::

   INFO:Plotypus:Setting population_size=250 on NSGAII
   INFO:Plotypus:NSGAII starting
   INFO:Plotypus:NSGAII finished; Total NFE: 10000, Elapsed Time: 0:00:06.216727
...
.. code:: bash
   ...
   plotypus hypervolume --reference_set ./examples/DTLZ2.2D.pf NSGAII_DTLZ2.set
...
.. code:: bash
   ...
   plotypus filter --output NSGAII_DTLZ2_unique.set --feasible --unique NSGAII_DTLZ2.set
   plotypus filter --output NSGAII_DTLZ2_epsilons.set --epsilons 0.01,0.01 NSGAII_DTLZ2.set
...
.. code:: bash
   ...
   plotypus normalize --output NSGAII_DTLZ2_normalized.set --reference_set ./examples/DTLZ2.2D.pf NSGAII_DTLZ2.set
   plotypus normalize --output NSGAII_DTLZ2_normalized.set --minimum 0.0,0.0 --maximum 1.0,1.0 NSGAII_DTLZ2.set
...
.. code:: bash
   ...
   plotypus plot NSGAII_DTLZ2.set
   plotypus plot --output NSGAII_DTLZ2.png NSGAII_DTLZ2.set
...
.. code:: bash
   ...
   plotypus solve --algorithm NSGAII --problem DTLZ2 --nfe 10000 | \
       plotypus filter --epsilons 0.01,0.01 | \
       plotypus plot
